...
public class AuthzRepositoryTest {
    ...
    public void testCompareTo() {
        assertTrue("Null repositories should match", new AuthzRepository(null)
                .compareTo(new AuthzRepository(null)) == 0);
    ...
    public void testEquals() {
        ...
        assertTrue("Values should match", new AuthzRepository(null)
                .equals(new AuthzRepository(null)));
        assertFalse("Values should not match", new AuthzRepository("name")
                .equals(new AuthzRepository("name2")));
        assertFalse("Values should not match", new AuthzRepository(null)
                .equals(new AuthzRepository("name2")));
