...
public class AuthzPathTest {
    ...
    public void testCompareTo() {
        ...
        assertTrue("Paths should not match", new AuthzPath(null, "/path")
                .compareTo(new AuthzPath(null, "/qath")) < 0);
        assertTrue("Paths should not match", new AuthzPath(null, "/qath")
                .compareTo(new AuthzPath(null, "/path")) > 0);
    }
    ...
    public void testEquals() {
        ...
        assertFalse("Values should not match", new AuthzPath(
                new AuthzRepository("repo1"), "name").equals(new AuthzPath(
                new AuthzRepository("repo2"), "name")));
        assertFalse("Values should not match", new AuthzPath(null, "name")
        ...
        assertFalse("Values should not match", new AuthzPath(null, "name")
                .equals(""));
        assertFalse("Values should not match", new AuthzPath(null, "name")
                .equals(new AuthzPath(null, "name").toString()));
    }

    @Test
    public void testHashCode() {
        assertTrue("HashCode values should match", new AuthzPath(null, "name")
                .hashCode() == new AuthzPath(null, "name").hashCode());
        assertFalse("HashCode values should not match", new AuthzPath(null,
                "name").hashCode() == new AuthzPath(null, "name2").hashCode());
    }
