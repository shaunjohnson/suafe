...
import net.lmxm.suafe.gui.*;
import net.lmxm.suafe.gui.dialogs.*;
import net.lmxm.suafe.exceptions.AppException;
import net.lmxm.suafe.gui.frames.menus.GroupsPopupMenu;
import net.lmxm.suafe.gui.frames.menus.MainFrameMenuBar;
import net.lmxm.suafe.gui.frames.menus.PopupMenuListener;
import net.lmxm.suafe.gui.frames.menus.UsersPopupMenu;
import net.lmxm.suafe.gui.frames.panes.AccessRulesPane;
import net.lmxm.suafe.gui.frames.panes.GroupsPane;
import net.lmxm.suafe.gui.frames.panes.UsersPane;
import net.lmxm.suafe.gui.frames.toolbars.MainFrameToolBar;
import net.lmxm.suafe.gui.models.NonEditableTableModel;
...
public final class MainFrame extends BaseFrame implements ActionListener, FileOpener, KeyListener,
    ...
    private void setIconImageForHelp(final HelpBroker hb, final Image image) {
        ...
        jfrmHelp.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
    }
