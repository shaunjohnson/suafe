...
public class Constants {
	...
	public static final String APP_PATH_SEPARATOR = "/";
	...
	public static final String ARGS_RENAME_GROUP = "renamegroup";

	public static final String ARGS_RENAME_REPOS = "renamerepos";

	public static final String ARGS_RENAME_USER = "renameuser";
	...
	public static final String DEFAULT_PATH = APP_PATH_SEPARATOR;
	...
	public static final String TEXT_ALL_USERS = "*";

	public static final String TEXT_GROUP_PREFIX = "@";
