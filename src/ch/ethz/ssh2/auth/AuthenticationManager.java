 ...
 * @version $Id: AuthenticationManager.java,v 1.12 2005/08/29 14:24:58 cplattne Exp $
 */
public class AuthenticationManager implements MessageHandler
{
	...
	public boolean authenticatePublicKey(String user, char[] PEMPrivateKey, String password) throws IOException
	{
		try
		{
			initialize(user);
