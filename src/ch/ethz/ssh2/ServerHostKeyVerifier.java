 ...
 * @version $Id: ServerHostKeyVerifier.java,v 1.3 2005/08/11 12:47:31 cplattne Exp $
 */
...
public interface ServerHostKeyVerifier
{
	 ...
	 * @throws Exception Will be wrapped with an IOException, extended version of return false =)
	 */
