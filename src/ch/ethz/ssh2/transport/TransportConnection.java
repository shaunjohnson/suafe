 ...
 * @version $Id: TransportConnection.java,v 1.6 2005/12/05 17:13:26 cplattne Exp $
 */
public class TransportConnection
{
	...
	{
		cis = new CipherInputStream(new NullCipher(), is);
		cos = new CipherOutputStream(new NullCipher(), os);
	}
	...
	public void changeSendCipher(BlockCipher bc, MAC mac)
	{
		if ((bc instanceof NullCipher) == false)
		{
			...
			/* Once we start encryption, there is no way back */
		}
