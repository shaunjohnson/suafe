 ...
 * @version $Id: TransportManager.java,v 1.9 2005/12/05 17:13:26 cplattne Exp $
 */
public class TransportManager
{
		...
		public void run()
		{
			while (true)
			{
				...
				synchronized (asynchronousQueue)
				{
					...
					{
						/* After the queue is empty for 2 seconds, stop this thread */
	...
	public TransportManager(String host, int port) throws IOException
	{
		...
		try
		{
			...
			InetAddress addr = createInetAddress(host);
		...
		tc = new TransportConnection(sock.getInputStream(), sock.getOutputStream());
	}
			...
			throws IOException
	{
		...
		km = new KexManager(this, csh, cwl, hostname, port, verifier);
	...
	public void sendAsynchronousMessage(byte[] msg) throws IOException
	{
		synchronized (asynchronousQueue)
		{
			 ...
			 * can flood us with global requests and (by not reading any data anymore)
			 * will put us in a low memory situation (our queue would grow and grow...) */
