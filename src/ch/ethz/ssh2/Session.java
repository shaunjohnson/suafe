 ...
 * @version $Id: Session.java,v 1.6 2005/12/07 13:14:24 cplattne Exp $
 */
public class Session
{
	 ...
	 * @throws IOException
	 */
	public synchronized void requestX11Forwarding(String hostname, int port, byte[] cookie, boolean singleConnection)
			throws IOException
	{
		if (hostname == null)
	 ...
	 * @throws IOException
	 */
	public synchronized void startSubSystem(String name) throws IOException
	{
		if (name == null)
	...
	/**
	 * This method blocks until certain conditions hold true on the underlying SSH2 channel.
	 * <p>
	...
	public synchronized int waitForCondition(int condition_set, long timeout)
	{
		if (timeout < 0)
