 ...
 * @version $Id: CipherInputStream.java,v 1.2 2005/12/05 17:13:27 cplattne Exp $
 */
public class CipherInputStream
{
	...
	private int internal_read() throws IOException
	{
		...
		return (input_buffer[input_buffer_pos++] & 0xff);
	}
	...
	public int readPlain(int b) throws IOException
	{
		if (pos != blockSize)
