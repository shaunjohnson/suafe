...
public class HelpFrame extends BaseFrame implements HyperlinkListener {
	...
	private JEditorPane getJEditorPane() {
		if (jEditorPane == null) {
			...
			URL helpUrl = this.getClass().getResource("/org/xiaoniu/suafe/resources/help/help.html");
	...
	public void hyperlinkUpdate(HyperlinkEvent evt) {
		if (evt.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
			...
			try {
				getJEditorPane().setPage(evt.getURL());
			} 
			catch (IOException e) {
	...
	private JEditorPane getJEditorPane1() {
		if (jEditorPane1 == null) {
			...
			URL helpUrl = this.getClass().getResource("/org/xiaoniu/suafe/resources/help/toc.html");
