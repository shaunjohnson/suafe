...
public class EditGroupDialog extends ParentDialog implements ActionListener {
	...
	private JPanel getJContentPane() {
		if(jContentPane == null) {
			...
			jContentPane.add(new JLabel(ResourceUtil.getString("editgroup.instructions")), BorderLayout.NORTH);
	...
	private JPanel getFormSubPanel() {
		if (formSubPanel == null) {
			...
			formSubPanel.add(new JLabel(ResourceUtil.getString("editgroup.groupname")));
